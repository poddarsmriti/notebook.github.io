...
titleTag=popupBox.querySelector("input"),//get the notes value
...
function showNotes(){
    ...
    notes.forEach((note, index)=>{
        let liTag=`<li class="notes">
                      ...
                      <span>${note.date}</span>
                     <div class="settings">
                      <i onclick="showMenu(this)" class="fa fa-list-ul"></i>
                      <ul class="menu">
                      <li onclick="updateNote(${index},'${note.title}','${note.description}')"><i class="fa fa-edit" style="font-size:24px"></i>Edit </li>
